 ...
 *
 */
public class HelloTwoScheduler {
    public static void main(String[] args) throws SchedulerException {
        // 创建一个JobDetail实例，将该实例与HelloJob Class绑定  并传人相关参数和值
        JobDetail jobDetail = JobBuilder.newJob(HelloTwoJob.class).withIdentity("myJob")
                .usingJobData("message","hello myJob1")
                .usingJobData("FloatJobValue",3.14F).build();   //Builder模式
